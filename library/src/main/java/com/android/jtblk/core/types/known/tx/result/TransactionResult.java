package com.android.jtblk.core.types.known.tx.result;
...
public class TransactionResult implements Comparable<TransactionResult> {
    ...
    public enum Source {
        request_tx_result, request_account_tx, request_account_tx_binary, request_tx_binary, ledger_transactions_expanded_with_ledger_index_injected, transaction_subscription_notification
    }
    ...
    public static TransactionResult fromJSON(JSONObject json) {
        boolean binary;
        String metaKey = json.containsKey("meta") ? "meta" : "metaData";
        String txKey = json.containsKey("transaction") ? "transaction" : json.containsKey("tx") ? "tx" : json.containsKey("tx_blob") ? "tx_blob" : null;
        if (txKey == null && !json.containsKey("TransactionType")) {
        ...
        long ledger_index = json.getLongValue("ledger_index");
        ...
        if (json.containsKey("ledger_hash")) {
    ...
    public TransactionResult(JSONObject json, Source resultMessageSource) {
        ...
        if (resultMessageSource == Source.transaction_subscription_notification) {
            ...
            validated = json.getBooleanValue("validated");
            if (validated && !json.containsKey("meta")) {
