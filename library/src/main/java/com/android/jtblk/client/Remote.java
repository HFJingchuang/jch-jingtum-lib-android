...
import com.android.jtblk.client.bean.Ledger;
import com.android.jtblk.client.bean.LedgerClosed;
import com.android.jtblk.client.bean.LedgerInfo;
import com.android.jtblk.client.bean.Marker;
import com.android.jtblk.client.bean.Memo;
import com.android.jtblk.client.bean.ServerInfo;
                    ...
                    if ("ModifiedNode".equals(node.get("diffType")) ||
                        ...
                        if (effect.get("effect").equals("offer_cancelled")) {
                            ...
                            if (transtacion.getType().equals("offercancel")) {
                                transtacion.setGets(parseAmount(fields.get("TakerPays")));
                                transtacion.setPays(parseAmount(fields.get("TakerGets")));
                            }
                            effect.put("gets", parseAmount(fields.get("TakerPays")));
                            effect.put("pays", parseAmount(fields.get("TakerGets")));
                            effect.put("type", sell ? "sell" : "buy");
