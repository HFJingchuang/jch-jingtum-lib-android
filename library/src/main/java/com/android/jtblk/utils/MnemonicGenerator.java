...
public final class MnemonicGenerator {
     ...
     */
    public String generateMnemonic(byte[] initialEntropy) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            mnemonicBuilder.append(this.wordList.getWord(index));
     ...
     */
    public byte[] generateEntropy(String mnemonic) {
    ...
    private int mnemonicToBits(String mnemonic, BitSet bits) {
        int bit = 0;
        final StringTokenizer tokenizer = new StringTokenizer(mnemonic, " ");
        while (tokenizer.hasMoreTokens()) {
            final String word = tokenizer.nextToken();
            final int index = this.wordList.getIndex(word);
            if (index < 0) {
                throw new IllegalArgumentException(
